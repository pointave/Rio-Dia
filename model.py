...
class Dia:
    ...
    def from_pretrained(
        ...
        Raises:
            ...
            RuntimeError: If there is an error loading the checkpoint.
        """
        # Replace this part if you want to load from a local folder instead of auto-downloading
        # Assuming that 'config.json' and 'dia-v0_1.pth' are in the same directory as the script
        config_path = r"C:\Users\point\Github\dia\model\config.json"  # Update this with your actual path
        checkpoint_path = r"C:\Users\point\Github\dia\model\dia-v0_1.pth"  # Update this with your actual path
